...
-To run the pcl_publisher:
	roslaunch coop_pcl pcl_test.launch
					or
	roslaunch coop_pcl pcl_test.launch resolution:="0.001" pcd_file:="test_pcd.pcd" cloud_width:="30000"  <--[for custom args]
-To run the octree_visualizer:
	roslaunch coop_pcl octree_visual_test.launch
					or 
	roslaunch coop_pcl octree_visual_test.launch resolution:="0.001" pcd_file:="test_pcd.pcd"  <--[for custom args]
